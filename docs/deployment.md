...
Reference numbers (M-series laptop, release build, 300-node corpus, 8
threads): ~580 req/s mixed with retrieve p95 ≤ 50 ms. Runs in CI with a
generous 250 ms SLO for shared runners.
